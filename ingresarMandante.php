                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="50" placeholder="Observación" name="observacion" class="form-control" required></textarea>                        
                      </div>     
                      <div class="clearfix">
