  ...
  include("Zebra_Pagination.php");
	...
	function imprimirMenu(){
		...
		<div class="col-md-2 col-sm-1 hidden-xs display-table-cell valign-top" id="side-menu">
          ...
          <ul>
            <li class="link">
              <a href="#usuarios" data-toggle="collapse" aria-controls="collapse-post">
                <span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                <span class="hidden-sm hidden-xs">Usuarios</span>
              </a>
              <ul class="collapse collapseable" id="usuarios">
            ...
            <li class="link">
              <a href="#miempresa" data-toggle="collapse" aria-controls="collapse-post">
                <span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span>
                <span class="hidden-sm hidden-xs">Mi empresa</span>
              </a>
              <ul class="collapse collapseable" id="miempresa">
                <li><a href="#">Administrar</a></li>
              </ul>
            </li>

            <li class="link">
              <a href="#verificacion" data-toggle="collapse" aria-controls="collapse-post">
                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>
                <span class="hidden-sm hidden-xs">Verificación</span>
              </a>
              <ul class="collapse collapseable" id="verificacion">
                <li><a href="#">Rut</a></li>
            ...
            <li class="link">
              <a href="#mandante" data-toggle="collapse" aria-controls="collapse-post">
                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>
                <span class="hidden-sm hidden-xs">Empresa Mandante</span>
              </a>
            ...
            <li class="link">
              <a href="#contratos" data-toggle="collapse" aria-controls="collapse-post">
                <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>
                <span class="hidden-sm hidden-xs">Contratos</span>
              </a>
              <ul class="collapse collapseable" id="contratos">
            ...
            <li class="link">
              <a href="#acreditacion" data-toggle="collapse" aria-controls="collapse-post">
                <span class="glyphicon glyphicon-ok" aria-hidden="true"></span>
                <span class="hidden-sm hidden-xs">Acreditación</span>
              </a>
              <ul class="collapse collapseable" id="acreditacion">
                <li><a href="#">Trabajador</a></li>
                <li><a href="ingresarTrabajador.php">Agregar Trabajador</a></li>
            ...
            <h1 class="hidden-xs hidden-sm logo"><img src=""></h1>
          </ul>
        </div>
		';
	}
