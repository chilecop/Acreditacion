    ...
    <div class="container-fluid display-table">
      <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top">
          ...
          <div id="content">
            <header>
              <h2 class="page_title">Crear Usuario</h2>
            </header>
            <div class="content-inner">
              <div class="form-wrapper">
              <p>Ingrese cada uno de los datos para crear un usuario con acceso al sistema.</p>
                <form action="php/ingresarMandante.php" method="post" autocomplete="off">
                  <div class="row">
                    <div class="col-md-6 col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Fono" name="direccion">
                      </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                      <div class="form-group">
                        <label class="sr-only">Rut</label>
                        <input type="text" class="form-control" id="title" placeholder="Rut" name="rut" required autocomplete="off" required>
                      </div>
                      <div class="form-group">
                        <label class="sr-only">Password</label>
                        <input type="password" class="form-control" id="title" placeholder="Password" name="pass" autocomplete="off" required>
                      </div>
                      <div class="clearfix">
                        <button type="submit" class="btn btn-primary pull-right"> Ingresar Mandante</button>
                      </div>
                    </div>
                  </div>
                </form>
