          ...
          <div id="content">
            ...
            <div class="content-inner">
              <div class="form-wrapper">
                <form action="php/ingresarEmpresa.php" method="post">
                  <div class="row">
                    <div class="col-md-6 col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Giro" name="giro" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Ciudad" name="ciudad" required>
                      </div>
                      <div class="form-group">
                        <label class="sr-only">Representante Legal</label>
                        <input type="text" class="form-control" id="title" placeholder="Representante Legal" name="representante" required>
                      </div>
                      <div class="form-group">
                        <label class="sr-only">Email</label>
                        <input type="email" class="form-control" id="title" placeholder="Email" name="email" required>
                      </div>
                    </div>
                    <div class="col-md-5 col-lg-5">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="title" name="icontrato" required>
                      </div>
                      <div class="form-group">
                        <label class="sr-only">Término de Contrato</label>
                        <input type="date" class="form-control" id="title" name="tcontrato" required>
                      </div>
                      <div class="form-group">
                        <label class="sr-only">Contacto Emergencia</label>
                        <input type="text" class="form-control" id="title" placeholder="Contacto Emergencia" name="contacto" required>
                      </div>
                      <div class="form-group">
                        <label class="sr-only">Teléfono Emergencia</label>
                        <input type="text" class="form-control" id="title" placeholder="Teléfono Emergencia" name="telefono" required>
                      </div>
                      <div class="clearfix">
                        <button type="submit" class="btn btn-primary pull-right"> Ingresar Empresa</button>
                      </div>
                    </div>
                  </div>
                </form>
