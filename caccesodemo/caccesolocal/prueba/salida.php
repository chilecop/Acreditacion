...
function limpiarut_(objeto){
	...
	<?php 
	function inputrut($name,$value='',$size=20,$leng=10,$otro=""){
		global $con;	  	  	  
		$input="<input name='".$name."' id='".$name."'  type=\"text\" value='".$value."' autofocus size=".$size." class=\"idle\"  maxlength=".$leng." onBlur=\"javascript:limpiastring(this)\" onBlur=\"javascript:valrut(this)\"  onkeydown=\"javascript:limpiarut_(this)\" onkeyup=\"javascript:limpiarut_(this)\" ".$otro." required>";	  			 
		return $input;	}
