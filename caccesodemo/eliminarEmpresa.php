...
<html lang="en">
  <head>
    ...
    $respuesta = puedoEliminarEmpresa($id);
    if(!($respuesta == "si")){
      $respuesta = "No puede eliminar la empresa <b>" . $_GET['nombre'] ."</b>, ya que actualmente existen <b>" . $respuesta . "</b> trabajadores en la base de datos pertenecientes a dicha empresa.";
    }
    ?>
  </head>
  <body>
