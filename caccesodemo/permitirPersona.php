...
<html lang="en">
  <head>
    ...
    $respuesta = getDatosProhibicion($id);
    list($nombre,$rut,$razon) = explode("%$",$respuesta);
    ?>
  </head>
  <body>
    <div class="container-fluid display-table">
      <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top">
          ...
          <div id="content">
            <header>
              <h2 class="page_title">Permitir Persona</h2>
            </header>
            <div class="content-inner">
              <div class="form-wrapper">
                <form action="php/permitirPersona.php" method="POST">
                  ¿Está seguro de permitir el acceso a la siguiente persona?<br><br>
                  <div class="form-group">
                    <label><?php echo $nombre; ?></label>
                  </div>
                  <div class="form-group">
                    <label><?php echo $rut; ?></label>
                  </div>
                  ...
                  <div class="clearfix">
                    <button type="submit" class="btn btn-success pull-right">Permitir Persona</button>
                  </div>
                </form>
              </div>
            </div>
