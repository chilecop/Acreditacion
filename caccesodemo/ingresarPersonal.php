...
<html lang="en">
  <head>
    ...
    <?php  
    if(isset($_GET['error'])){
      echo "La persona ya se encuentra en la base de datos.";
    }
    ?>
  </head>
  <body>
    <div class="container-fluid display-table">
      <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top">
          ...
          <div id="content">
            <header>
              <h2 class="page_title">Ingresar Personal</h2>
            </header>
            <div class="content-inner">
              <div class="form-wrapper">
                <form action="php/ingresarPersona.php" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Rut: 8546321k" name="rut" required></input>
                  </div>

                  <div class="form-group">
                    <?php getEmpresasSelect(); ?>
                  </div>
                  <div class="form-group">
                    <label class="sr-only">Cargo</label>
                    <input type="text" class="form-control" placeholder="Cargo" name="cargo" required></input>
                  </div>
                  <div class="clearfix">
                    <?php
                    if($_GET['error']=="si"){
                      echo 'Rut duplicado: La persona ya se encuentra en la base de datos.';
                    }elseif ($_GET['error']=="no"){
                      echo 'Persona ingresada correctamente.';
                    }
                    ?>
                    <button type="submit" class="btn btn-primary pull-right"> Ingresar Personal</button>
                  </div>
                </form>
              </div>
            </div>
