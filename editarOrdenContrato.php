    ...
    <div class="container-fluid display-table">
      <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top">
          ...
          <div id="content">
            <header>
              <h2 class="page_title">Editar Orden de Contrato</h2>
            </header>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-lg-4">                      
                      <div class="form-group">
                        ...
                        <input class="pull-right" type="date" name="fechainicio" value="<?php echo $fechaInicio; ?>" placeholder="Fecha Inicio" required/>
                      </div>
                      <div class="form-group">
                        <label class="">Término Contrato</label>
                        <input class="pull-right" type="date" name="fechatermino" value="<?php echo $fechaTermino; ?>" placeholder="Fecha Termino" required/>
                      </div>
                      <div class="form-group">
                        <label class="">Inicio Jornada</label>
                        <input class="pull-right" type="date" name="iniciojornada" value="<?php echo $fechaInicioJornada; ?>" placeholder="Fecha Inicio" required/>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="col-md-4 col-lg-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Descripción" name="descripcion" value="<?php echo $descripcion; ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Administrador Contacto</label>
                        <input type="text" class="form-control" id="title" placeholder="Administrador de Contacto" name="n_contacto" value="<?php echo $ncontacto; ?>" required>
                      </div>    
                      <div class="form-group">
                          <label>Fono</label>
                    ...
                    <div class="col-md-4 col-lg-4">
                      <div class="form-group">
                        <label >E-mail</label>
                        <input type="email" class="form-control" id="title" placeholder="E-mail" name="email" value="<?php echo $email; ?>" required>
                      </div>
                      <div class="form-group">
                        <label >Jornada Excepcional</label>
                        <input type="text" class="form-control" id="title" placeholder="Jornada Excepcional" name="jexcepcional" value="<?php echo $jexcepcional; ?>" required>
                      </div>
                      <div class="form-group">
                        <label >Tipo Jornada</label>
                        <input type="text" class="form-control" id="title" placeholder="Tipo Jornada" name="tjornada" value="<?php echo $tjornada; ?>" required>
                      </div>
                      <div class="form-group">
                        <label class=>N° Resolución</label>
                        <input type="text" class="form-control" id="title" placeholder="Número Resolución" name="nresolucion" value="<?php echo $nresolucion; ?>" required>
                      </div>
                      <div class="clearfix">
                        <button type="submit" class="btn btn-warning pull-right"> Editar Orden de Contrato</button>
                      </div>
                    </div>
                  </div>
                </form>
