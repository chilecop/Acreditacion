	          ...
	          <div id="content">
	            <header class="clearfix">
	              ...
	              <div class="col-xs-7 col-sm-9 col-md-9">
	              	<a class="btn btn-xs btn-success pull-right" href="generarPase.php" role="button">Solicitar Pase</a>	
	              </div>
	            </header>
...
<?php
  ...
  header("location: http://www.chilecop.cl/acreditacion/escritorio.php
  ");
}
?>